...
from post.post_exp_cas2 import check_train_results, get_max_e1_init, load_trained_model


# curriculum training
E1NET_PATH = "output/v1/e1_net_seq1.pth"
E1NET_INTER_PATH = "output/v1/e1_net_seq1_"
