...
def pre_compute_validation_data(p_net, e1_net, OUTPUT_PATH, PRE_COMPUTE_FLAG=False):
    ...
    t_check = np.linspace(constants.T_PRIME_SPAN[0], constants.T_PRIME_SPAN[-1], 6, endpoint=True)
...
def main():
    ...
    e1_net = E1Net_XL(constants, scale=0.02*scale_torch, normalize=scale_torch*0.02)
