...
# enet best epoch:  48347 , loss: tensor(0.0009)
# eL:  0.021 	 alpha:  0.125
# eL:  0.019 	 alpha:  0.128
# eL:  0.013 	 alpha:  0.217
# eL:  0.01 	 alpha:  0.379
# eL:  0.009 	 alpha:  0.516
# eL:  0.008 	 alpha:  0.636
# train pnet time: 1092.9883 seconds
# train enet time: 5029.8789 seconds

FOLDER = "exp1/exp1-PENN_pe-RG/"
...
def main():
    ...
    # train_pnet_model(p_model, optimizer_p_model, scheduler_p_model, mse_cost_function, iterations=20000); print("[pnet train complete]")
    end_time = time.time()
