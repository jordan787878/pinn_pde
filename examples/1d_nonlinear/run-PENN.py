...
# Position Encoding NN + baseline train
# Log:
# t1= 0.5 , a1 [Monte]= 0.09535654642299425
# t1= 1.0 , a1 [Monte]= 0.37449425593349533
# t1= 2.0 , a1 [Monte]= 1.2080021072528015
# t1= 3.0 , a1 [Monte]= 1.9805863739368277
# t1= 4.0 , a1 [Monte]= 1.2995368592750642
# t1= 5.0 , a1 [Monte]= 1.2271310273300553
# train pnet time: 1150.6298 seconds
# train e1net time: 6030.8950 seconds

FOLDER = "exp1/run-PENN/"
...
def train_p_net(p_net, optimizer, scheduler, mse_cost_function, max_abs_p_ti, iterations=40000):
    ...
    for epoch in range(iterations):
        ...
        loss.backward(retain_graph=False) # This is for computing gradients using backward propagation
