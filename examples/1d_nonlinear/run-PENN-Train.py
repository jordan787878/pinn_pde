...
def main():
    ...
    start_time = time.time()
    train_enet_model(p_model, e_model, optimizer_e_model, scheduler_e_model, mse_cost_function, iterations=30000); print("[enet train complete]")
    end_time = time.time()
